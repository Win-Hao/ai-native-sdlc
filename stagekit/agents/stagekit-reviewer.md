...
- **Compliance** — the diff against `stagekit/<id>/spec.md`: requirements missing or
  ...
  `stagekit/<id>/plan.md`, `CLAUDE.md` and any skills in `.claude/skills/`. Without
